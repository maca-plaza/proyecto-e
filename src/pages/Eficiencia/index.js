...
import { faLightbulb, faGamepad } from "@fortawesome/free-solid-svg-icons";
import "./styles.css";
      ...
      <body>
        ...
        <section className="container-xxl">
          <div className="content">
            ...
            <div className="content_imagen">
              <img
                src="https://lh3.google.com/u/0/d/1TGCLNVS3gzKAjAc_ydZGMibtYoFGWQMb=w1439-h753-iv1"
                alt=""
              />
            </div>
          </div>
            ...
            <div className="content_info">
              ...
              <ul>
                ...
                <li>
                  ...
                  Led o de bajo consumo). Así podrás conseguir un ahorro de
                  hasta 90%, con respecto a las ampolletas antiguas.
                </li>
                <li>
          ...
          <div className="content">
            <div className="content_info">
              ...
              <ul>
                <li>
                  Plancha la mayor cantidad de prendas y No dejes encendida más
                  de lo necesario.
                </li>
                <li>
            ...
            <div className="content_imagen">
              <img
                src="https://lh3.google.com/u/0/d/1QQqQ4riGQagmUCcVQVJttqhtYuz-3kmR=w1439-h460-iv1"
                alt=""
              />
            </div>
          </div>
          ...
          <div className="content content_reverse">
            <div className="content_info">
              ...
              <p>
                ...
                indican que están consumiendo energía, aunque estén apagados.
                Para evitar este consumo vampiro, debes desenchufar los
                artefactos eléctricos o utilizar un alargador o (zapatilla) con
                interruptor.
              </p>
              <ul>
                ...
                <li>
                  Utiliza alargadores con interruptor porque permiten apagar
                  todos los artefactos que estés utilizando.
                </li>
                <li>
                  Recuerda adquirir alargadores (o zapatillas) que cuenten con
                  el sello de la SEC.
                </li>
              </ul>
            </div>
            <div className="content_imagen">
              <img
                src="https://lh3.google.com/u/0/d/1Qk5wn28dueNw19D1ov8cKeEQmc1D8DXd=w1439-h460-iv1"
                alt=""
              />
            </div>
          </div>
        ...
        <div className="cards">
          <div className="card_info">
            ...
            <div className="card_info">
              <FontAwesomeIcon icon={faGamepad} className="icon_cardd" />
                <div className="card-body">
                    <Link to="/juego">
                      <h3>¿Quieres aprender jugando?</h3>
                      <p className="card-text">
                        Juego interactivo de Tower Defense para aprender más sobre eficiencia energetica
                      </p>
            ...
            <div className="card-body">
              ...
              <p className="card-text">
                ...
                menos recursos, lo que contribuye a reducir la huella de
                carbono.
              </p>
            </div>
          </div>
