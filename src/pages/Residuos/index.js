      ...
      <main>
        ...
        <div className="container-fluid">
          ...
          <div className="basura-1">
            ...
            <div className="basura">
              ...
              indeseable, eso depende del origen y composición de estado que ya
              no se le puede dar otro uso o no tiene ninguna utilidad posible
            </div>
          </div>
          ...
          <div className="content_texto">
            ...
            <div className="residuos-textos">
              ...
              <div className="textos">
                Desechos que debido a sus propiedades químicas, físicas o
                biológicas representan un riesgo significativo para la salud
          ...
          <div className="residuos-textos">
            ...
            <div className="textos">
              {" "}
              Materiales desechados que no presentan riesgos significativos para
              la salud humana ni el medio ambiente, como residuos orgánicos o
        ...
        <div className="content_texto">
          ...
          <div className="residuos-textos">
            ...
            Desperdicios generados en hogares, comercios e instituciones, que
            incluyen desde residuos orgánicos hasta envases y materiales
            reciclables.
          </div>
          <div className="iconos">
          ...
          <div className="residuos-textos">
            ...
            Subproductos o desechos derivados de procesos industriales que
            requieren gestión especializada debido a sus características y
            posibles impactos ambientales y de salud.
          </div>
        </div>
        ...
        <div className="row row-cols-3 row-cols-lg-3 g-2 g-lg-3">
          <div className="col">
            <img
              ...
              alt=""
            />
            <button className="texto"> Gris Claro</button>
          </div>
          <div className="col">
            <img
              className="verde"
              ...
              alt=""
            />
            <button className="texto"> Verde</button>
          </div>
          <div className="col">
            <img
              className="beige"
              ...
              alt=""
            />
            <button className="texto"> Beige</button>
          </div>
          <div className="col">
            <img
              className="azul"
              ...
              alt=""
            />
            <button className="texto"> Azul</button>
          </div>
          <div className="col">
            <img
              className="rojo"
              ...
              alt=""
            />
            <button className="texto"> Rojo</button>
          </div>
          <div className="col">
            <img
              className="burdeos"
              ...
              alt=""
            />
            <button className="texto"> Burdeos</button>
          </div>
          <div className="col">
            <img
              ...
              alt=""
            />
            <button className="texto"> Gris Oscuro</button>
          </div>
          <div className="col">
            <img
              className="amarillo"
              ...
              alt=""
            />
            <button className="texto"> Amarillo</button>
          </div>
          <div className="col">
            <img
              className="cafe"
              ...
              alt=""
            />
            <button className="texto">Café</button>
          </div>
        </div>
